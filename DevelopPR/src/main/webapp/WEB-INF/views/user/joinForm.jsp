					...
					<form action="${path}/user/joining" name="form1" method="post">
						<ul>
							...
							<li><input id="email" type="text" autocomplete="off"
								...
								<p id="p2">이메일 인증이 진행되니 정확한 이메일 주소를 입력해 주시기 바랍니다.</p></li>
							<li><input id="name" type="text" autocomplete="off" value=""
								placeholder=" 이름" name="userName"></li>
							<li><input id="pwd" type="password" value=""
								placeholder=" 비밀번호" name="userPw">
								<p id="p3">비밀번호는 ~ 영문, 숫자, 특수문자를 조합해 주세요.</p></li>
							<li><input id="pwdChk" type="password" value=""
								placeholder=" 비밀번호 확인">
								<p id="p4">비밀번호를 다시 한번 입력해 주세요.</p></li>
							<li><input id="nickname" type="text" autocomplete="off"
								value="" placeholder=" 닉네임" name="userNick">
								<p id="p5">사용하실 닉네임을 2자~20자 한글, 영문, 숫자를 사용해 입력해주세요.</p></li>
