...
<body>
    <div class="co_registForm">
        ...
        <div class="container">
             <div id="input">
            <form:form name="form1" id="form1" commandName="CommunityVO" method="post" action="${path}/community/regist" enctype="multipart/form-data">
            <div id ="pageName">게시글 작성</div>
               ...
               <div class="content_input">
                  ...
                  <div id="contentInput"><input name="content" style="min-width:98%; height:350px; text-align : left; padding-left : 8px;" id="content" placeholder="내용을 입력해주세요"></div>
