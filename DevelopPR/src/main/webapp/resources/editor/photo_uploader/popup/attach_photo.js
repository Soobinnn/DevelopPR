    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= '/DevelopPR/community/multiplePhotoUpload';
    	/*sUploadURL= '/DevelopPR/community/multiplePhotoUpload'; 	//upload URL
*/    	
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/DevelopPR/community/photoUpload',	//샘플 URL입니다.
